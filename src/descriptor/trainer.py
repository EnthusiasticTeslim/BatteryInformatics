...
from utils import molecules_from_smiles, compute_rdkit_descriptors, scale, hyperparameter_optimization, load_hyperparameter_space, plot_prediction_scatter
...
def main(args):
    ...
    result_path = f"{args.parent_directory}/{args.result_directory}/{args.model}/{args.model}"
